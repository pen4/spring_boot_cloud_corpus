...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.springboot.rpc.bid.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.springboot.rpc.bid.HelloMessage,
      com.springboot.rpc.bid.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.springboot.rpc.bid.HelloMessage.class,
      responseType = com.springboot.rpc.bid.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.springboot.rpc.bid.HelloMessage,
      com.springboot.rpc.bid.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.springboot.rpc.bid.HelloMessage, com.springboot.rpc.bid.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.springboot.rpc.bid.HelloMessage, com.springboot.rpc.bid.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.springboot.rpc.bid.HelloService", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.springboot.rpc.bid.HelloMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.springboot.rpc.bid.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.springboot.rpc.bid.HelloMessage> sayHello(
        io.grpc.stub.StreamObserver<com.springboot.rpc.bid.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.springboot.rpc.bid.HelloMessage,
                com.springboot.rpc.bid.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.springboot.rpc.bid.HelloWorldGrpc.getDescriptor();
    }
