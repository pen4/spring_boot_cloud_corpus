...
public class HealthCheckServer {
    ...
    public static void main(String[] args) {
        ...
        int port =9010;
        String address2 = Inet4Address.getLocalHost().getHostAddress();
        System.err.println(address2+"自动获取地址");
    ...
    private static void registerToConsul(String address, int port) {
        Consul client = Consul.builder().withUrl("http://127.0.0.1:8500").build();
        ...
        Registration service = ImmutableRegistration.builder()
                                                    ...
                                                    .name("grpc-server")
                                                    .address(address)
                                                    .check(Registration.RegCheck.tcp(address + ":" + port, 10, 100))
                                                    .port(port)
