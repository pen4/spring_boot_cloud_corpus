...
public class DemoSQLConfig extends APIJSONSQLConfig {
    ...
    public String getDBVersion() {
        return "12.12";  // "8.0.11";  // TODO 改成你自己的 MySQL 或 PostgreSQL 数据库版本号  // MYSQL 8 和 7 使用的 JDBC 配置不一样
    }

    @JSONField(serialize = false)  // 不在日志打印 账号/密码 等敏感信息
    @Override
    public String getDBUri() {
        return "jdbc:postgresql://localhost:5432/postgres"; // TODO 改成你自己的，TiDB 可以当成 MySQL 使用，默认端口为 4000
    }
