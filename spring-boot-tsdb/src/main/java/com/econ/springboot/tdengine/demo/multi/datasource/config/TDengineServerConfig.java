package com.econ.springboot.tdengine.demo.multi.datasource.config;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.econ.springboot.tdengine.demo.multi.datasource.dao.tdengine"}, sqlSessionTemplateRef  = "tdengineSqlSessionTemplate")
