...
public class MailService {
    ...
    public BizResult<String> sendSimpleMail(MailVO ent) {
        ...
        try {
            ...
            log.info("简单邮件，发送结果：{}", JSON.toJSONString(bizResult));
        }
        return bizResult;
    }
    ...
    public BizResult<String> sendHtmlMail(MailVO ent) {
        ...
        try {
            ...
            log.info(String.format("HTML邮件，发送结果：%s", JSON.toJSONString(bizResult)));
        }
        return bizResult;
    }
    ...
    public void autoSend(Date startTime, Date endTime) {
        ...
        for (MailDO dbEnt : mailDOList) {
            ...
            dbEnt.setRemark(JSON.toJSONString(bizSendResult));
