...
public class BaseGenerator {
    ...
    protected static GlobalConfig.Builder globalConfig() {
        return new GlobalConfig.Builder().author("kxd").commentDate("yyyy-MM-dd").outputDir("D:\\autocode")
                ;
    }
    ...
    protected static PackageConfig.Builder packageConfig() {
        return new PackageConfig.Builder().parent("com.example.springboot.tdengine.demo.mybatisplus");
    }
